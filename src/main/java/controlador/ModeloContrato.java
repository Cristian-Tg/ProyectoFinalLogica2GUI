 ...
 * @author Acer
 */
public class ModeloContrato extends AbstractTableModel {
    public ListaContratos contratos;

    public ModeloContrato() {
        contratos = new ListaContratos();
    ...
    public ListaContratos filtrarCliente(String identificacion){
        ListaContratos contratosCliente = new ListaContratos();
        for (int i = 0; i < contratos.total(); i++) {
            Contrato c = contratos.obtener(i);
